 ...
 */
declare function getOpenAIAuth({ email, password, browser, page, timeoutMs, isGoogleLogin, isMicrosoftLogin, captchaToken, nopechaKey, executablePath, proxyServer }: {
    email?: string;
    password?: string;
    browser?: Browser;
    page?: Page;
