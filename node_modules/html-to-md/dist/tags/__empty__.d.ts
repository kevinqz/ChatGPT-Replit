...
declare class __Empty__ extends Tag {
    ...
    parseValidSubTag(subTagStr: string, subTagName: TagName, options: ParseOptions): string;
    parseOnlyString(subTagStr: string, subTagName: null, options: ParseOptions): string;
    exec(): string;
}
